/**
 * Porto home banner design start
 *
 */
const sliders = document.querySelector(".slider-item");

let slider_content = "";

slider.map((item, index) => {
  slider_content += ` <div class="owl-carousel owl-carousel-light owl-carousel-light-init-fadeIn owl-theme manual dots-inside dots-horizontal-center show-dots-hover nav-inside nav-inside-plus nav-dark nav-md nav-font-size-md show-nav-hover mb-0" data-plugin-options="{'autoplayTimeout': 7000}" data-dynamic-height="['670px','670px','670px','550px','500px']" style="height: 670px;">
...
sliders.innerHTML = slider_content;
/**
 * Porto home banner design end
 */

/**
 * Porto home page testomonial desing start
 */
const innerTestimonial = document.querySelector("#testimonial-item");
let mt_testimonial = "";
  ...
  <div class="col">
    <div class="testimonial testimonial-primary">
      ...
      <div class="testimonial-author">
        ...
        <p><strong>${item.name}</strong><span>${item.sub_name}</span></p>
      </div>
    </div>
  </div>
</div>
...
innerTestimonial.innerHTML = mt_testimonial;
/**
 * Porto home page testomonial desing end
 */
